...
export const Account: React.FC = () => {
  ...
  const handleAuth = (e: React.FormEvent) => {
    ...
    dispatch({ type: 'ADD_NOTIFICATION', payload: { text: `Welcome to the Soul Squad!`, type: 'success' } });
  };
  ...
  const copyReferral = () => {
    if (state.user?.referralCode) {
      ...
      dispatch({ type: 'ADD_NOTIFICATION', payload: { text: 'Referral code copied!', type: 'success' } });
    }
  };
  ...
  const ProfileHeader = () => (
    <div className="relative mb-12 animate-in fade-in slide-in-from-top-4 duration-700">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-red-600/10 to-indigo-600/10 rounded-[3rem] blur-3xl -z-10" />
      ...
      <div className="bg-white dark:bg-neutral-900 border border-gray-100 dark:border-neutral-800 rounded-[3rem] p-8 lg:p-12 shadow-2xl shadow-gray-200/50 dark:shadow-none flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="flex-grow text-center md:text-left">
          ...
          <p className="text-gray-400 font-bold text-sm tracking-widest mb-6 flex items-center justify-center md:justify-start gap-2">
            <User size={14} className="text-red-600" /> MEMBER SINCE OCT 2023
          </p>
        ...
        <div className="hidden xl:flex gap-6 border-l border-gray-100 dark:border-neutral-800 pl-10">
          ...
          <div className="w-px h-12 bg-gray-100 dark:border-neutral-800" />
          <div className="text-center">
  ...
  const DashboardHome = () => (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {/* Orders Summary Card */}
        <div className="bg-white dark:bg-neutral-900 p-8 rounded-[3rem] shadow-sm border border-gray-100 dark:border-neutral-800 hover:shadow-2xl transition-all group overflow-hidden relative">
          ...
          <div className="space-y-4 relative z-10">
            ...
            )) : <p className="text-sm text-gray-500 text-center py-4 italic">No active orders.</p>}
          </div>
        ...
        <div className="bg-black text-white p-8 rounded-[3rem] shadow-xl relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <h3 className="text-xl font-black uppercase italic tracking-tighter mb-2">Refer <span className="text-red-600">& Earn</span></h3>
            <p className="text-xs font-medium text-gray-400 mb-8 leading-relaxed">Give ₹250, Get ₹250. Invite your squad to the store!</p>
        ...
        <div className="bg-white dark:bg-neutral-900 p-8 rounded-[3rem] shadow-sm border border-gray-100 dark:border-neutral-800 group relative overflow-hidden">
          <div className="relative z-10">
            ...
            <button onClick={() => setActiveSection('membership')} className="w-full bg-gray-50 dark:bg-neutral-800 text-black dark:text-white py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-red-600 hover:text-white transition-all">My Benefits</button>
          </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {/* Fix: use components directly instead of elements and avoid React.cloneElement */}
        {[
  ...
  const EditProfileForm = () => (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <h2 className="text-3xl font-black uppercase italic tracking-tighter mb-12">Edit <span className="text-red-600">Profile</span></h2>
      <div className="bg-white dark:bg-neutral-900 p-10 lg:p-12 rounded-[3.5rem] shadow-sm border border-gray-100 dark:border-neutral-800">
        <form className="grid grid-cols-1 md:grid-cols-2 gap-8" onSubmit={(e) => {
          e.preventDefault();
          dispatch({ type: 'ADD_NOTIFICATION', payload: { text: 'Profile updated successfully!', type: 'success' } });
        }}>
            ...
            <div className="flex gap-4">
              {['Male', 'Female', 'Other'].map(g => (
                <button
                  ...
                  className={`flex-1 py-4 rounded-2xl font-black text-xs uppercase tracking-widest border-2 transition-all ${profileForm.gender === g ? 'bg-black text-white border-black shadow-xl' : 'bg-transparent border-gray-100 dark:border-neutral-800 text-gray-400'}`}
                >
                  {g}
                </button>
              ))}
          ...
          <div className="md:col-span-2 pt-8 flex gap-4">
            <button type="submit" className="flex-grow bg-red-600 text-white py-5 rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-2xl shadow-red-200 dark:shadow-none hover:bg-red-700 transition-all">Save Profile Changes</button>
  ...
  const SavedAddresses = () => (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex justify-between items-end mb-12">
        <h2 className="text-3xl font-black uppercase italic tracking-tighter">Saved <span className="text-red-600">Addresses</span></h2>
        ...
        {state.user?.addresses.map(addr => (
          <div key={addr.id} className="bg-white dark:bg-neutral-900 p-8 rounded-[3rem] border-2 border-transparent hover:border-red-600 transition-all shadow-sm relative group overflow-hidden">
            ...
            <div className="flex items-center gap-6 pt-8 border-t border-gray-100 dark:border-neutral-800 relative z-10">
              <button className="text-[10px] font-black uppercase text-gray-400 hover:text-black dark:hover:text-white flex items-center gap-2"><Edit3 size={14} /> Edit</button>
  ...
  const OrderHistory = () => (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-8">
      <h2 className="text-3xl font-black uppercase italic tracking-tighter mb-8">My <span className="text-red-600">Orders</span></h2>
      {state.orders.length > 0 ? state.orders.map(order => (
          ...
          <div className="bg-gray-50/50 dark:bg-neutral-800/50 p-8 border-b border-gray-100 dark:border-neutral-800 flex flex-wrap justify-between items-center gap-6">
            <div className="flex flex-wrap items-center gap-10">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-sm font-black flex items-center gap-1">{state.user?.name} <Info size={14} className="text-gray-300" /></p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-10 items-center">
              ...
              <div className="flex-grow">
                ...
                <div className="flex gap-6 mb-8">
                  ...
                  <button className="bg-white dark:bg-neutral-900 border-2 border-gray-100 dark:border-neutral-800 text-gray-800 dark:text-white px-8 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:border-red-600 hover:text-red-600 transition-all">Buy Again</button>
                </div>
                <div className="flex gap-4">
                  <button className="text-[10px] font-black uppercase text-gray-400 hover:text-black dark:hover:text-white flex items-center gap-1.5"><ExternalLink size={12} /> View Details</button>
                  <button className="text-[10px] font-black uppercase text-gray-400 hover:text-black dark:hover:text-white flex items-center gap-1.5"><Download size={12} /> Invoice</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-neutral-900 p-20 rounded-[4rem] text-center shadow-sm border border-gray-100 dark:border-neutral-800">
          ...
          <p className="text-gray-500 dark:text-gray-400 font-medium mb-10">Gear up with our latest collection and join the squad.</p>
          <button onClick={() => navigate('/products')} className="bg-black text-white px-12 py-5 rounded-2xl font-black text-xs uppercase tracking-widest shadow-2xl hover:bg-red-600 transition-all">Shop Collections</button>
        </div>
      )}
    </div>
  );
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="bg-gradient-to-br from-indigo-700 to-indigo-900 p-12 rounded-[4rem] text-white shadow-2xl relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <CreditCard className="opacity-40 mb-10" size={64} />
            <p className="text-[10px] font-black uppercase tracking-[0.3em] opacity-70 mb-4">Soul Wallet Balance</p>
            <h2 className="text-7xl font-black italic tracking-tighter mb-12">₹{state.user?.walletBalance}</h2>
            <div className="flex gap-4">
              <button className="bg-white text-indigo-900 px-10 py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-xl hover:scale-105 transition-transform">Top Up</button>
      ...
      <div className="bg-white dark:bg-neutral-900 p-12 rounded-[3.5rem] shadow-sm border border-gray-100 dark:border-neutral-800">
        ...
        <div className="space-y-8">
          {[
            { id: 'TX-99', msg: 'Cashback: Multiverse Tee', amt: '+₹250', date: 'Yesterday', status: 'Credit' },
            { id: 'TX-98', msg: 'Order Payment: #ORD-7721', amt: '-₹999', date: 'Oct 14, 2024', status: 'Debit' },
            { id: 'TX-97', msg: 'Referral Bonus: John D.', amt: '+₹500', date: 'Oct 12, 2024', status: 'Credit' },
          ].map(tx => (
        ...
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 bg-neutral-900 rounded-[4rem] overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.5)] border border-white/5 relative z-10 animate-in zoom-in-95 duration-500">
          <div className="hidden lg:flex flex-col justify-between p-16 lg:p-24 bg-gradient-to-br from-red-600 to-red-800 text-white">
            ...
            <div>
              ...
              <p className="text-white/70 font-medium text-lg leading-relaxed max-w-sm">Exclusive drops, member-only prices, and legendary gear await you.</p>
            </div>
            <div className="flex items-center gap-6">
              <ShieldCheck size={24} className="opacity-40" />
              <p className="text-[10px] font-black uppercase tracking-widest opacity-40">256-bit SSL Encrypted Auth</p>
            </div>
          </div>

          <div className="p-10 lg:p-24 bg-neutral-900 flex flex-col justify-center">
            <div className="flex gap-10 mb-12">
              <button onClick={() => setAuthMode('login')} className={`text-sm font-black uppercase tracking-[0.2em] pb-2 border-b-2 transition-all ${authMode === 'login' ? 'text-red-600 border-red-600' : 'text-gray-500 border-transparent'}`}>Sign In</button>
              <button onClick={() => setAuthMode('register')} className={`text-sm font-black uppercase tracking-[0.2em] pb-2 border-b-2 transition-all ${authMode === 'register' ? 'text-red-600 border-red-600' : 'text-gray-500 border-transparent'}`}>New Account</button>
            </div>

            <form onSubmit={handleAuth} className="space-y-6">
              {authMode === 'register' && (
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">What should we call you?</label>
                  <input type="text" placeholder="Your Full Name" className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white outline-none focus:ring-2 focus:ring-red-600 transition-all font-bold placeholder:text-gray-700" required />
                </div>
              )}
              <div className="space-y-2">
                <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Email / Mobile Number</label>
              ...
              <button type="submit" className="w-full bg-red-600 text-white py-6 rounded-2xl font-black text-xs uppercase tracking-[0.3em] shadow-2xl shadow-red-600/30 hover:bg-red-700 active:scale-95 transition-all flex items-center justify-center gap-3">
                {authMode === 'login' ? 'Let Me In' : 'Join the Squad'} <ArrowRight size={18} />
              </button>
            </form>

            <div className="mt-16 flex items-center gap-4">
              <div className="flex-grow h-px bg-white/10" />
              <span className="text-[10px] font-black text-gray-600 uppercase">Or continue with</span>
              <div className="flex-grow h-px bg-white/10" />
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <aside className="lg:w-80 flex-shrink-0">
            <div className="bg-white dark:bg-neutral-900 rounded-[3rem] shadow-sm border border-gray-100 dark:border-neutral-800 p-6 space-y-2 sticky top-32">
              {/* Fix: use components directly instead of React.cloneElement */}
          ...
          <main className="flex-grow min-h-[600px]">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                  ...
                  {state.wishlist.length === 0 && (
                    <div className="col-span-full py-24 text-center">
                      ...
                      <p className="text-gray-500 font-bold uppercase tracking-widest text-xl">Your vault is currently empty.</p>
                      <button onClick={() => navigate('/products')} className="mt-8 bg-black text-white px-10 py-5 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl">Secure Some Gear</button>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="bg-black text-white p-16 lg:p-24 rounded-[4rem] shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    ...
                    <h2 className="text-6xl lg:text-9xl font-black italic tracking-tighter uppercase mb-8 leading-none">THE SQUAD <br/><span className="text-red-600">LIFE.</span></h2>
                    ...
                    <button className="bg-white text-black px-12 py-5 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-red-600 hover:text-white transition-all shadow-2xl">UPGRADE TO PLATINUM</button>
                  </div>
                </div>
              </div>
            )}
            {activeSection === 'coupons' && (
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <h2 className="text-3xl font-black uppercase italic tracking-tighter mb-12">Active <span className="text-red-600">Coupons</span></h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  {['SQUAD500', 'SUPER20', 'WELCOME250', 'FESTIVE10'].map(code => (
                    <div key={code} className="bg-white dark:bg-neutral-900 p-2 border-2 border-dashed border-gray-200 dark:border-neutral-800 rounded-[3rem] relative overflow-hidden group hover:border-red-400 transition-all">
                      <div className="p-10 rounded-[2.5rem] bg-gray-50 dark:bg-neutral-800/50 text-center">
                         ...
                         <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Applicable on orders above ₹1,999</p>
                         <div className="mt-8 flex gap-3">
                           ...
                           <button className="px-6 py-3 border border-gray-100 dark:border-neutral-800 rounded-xl font-black text-[10px] uppercase text-gray-400">T&C</button>
                         </div>
                      </div>
...
// --- ICON ALIASES ---
const Info = ({ className, size }: { className?: string, size?: number }) => <Star className={className} size={size} />;
